...
> this repo carries no version-suffixed files.
...
> `workflows/script_submitter/v3.6/hsp.yaml` (copy the `with:` block from
...
> and pass them all through to `workflows/script_submitter/v3.6/noaa.yaml`. Replicate
