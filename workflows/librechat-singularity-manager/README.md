...
A lightweight web UI for managing a running [librechat-singularity](../librechat/) session. Provides a browser-based dashboard to check service status, view logs, and restart individual containers without stopping the workflow job.
